...
class Codex_Xtest_Xtest_Fixture_Quote extends Codex_Xtest_Xtest_Fixture_Abstract
{
    ...
    public function getTest($customer = null)
    {
        ...
        $quote->getBillingAddress()->addData($this->getConfigFixture('order/billing_address'));
        $quote->getShippingAddress()->addData($this->getConfigFixture('order/shipping_address'));
